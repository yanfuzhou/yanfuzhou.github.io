...
Lidar Point Cloud (LPC) data is a popular source for building high precision and high resolution (>= 1/9 arc-second approximately 3 m) 
...
This project targeted at above challenges and tried to create massive production of HDSM by using USGS's public LIDAR dataset, which is hosted on their 
[ftp server](ftp://rockyftp.cr.usgs.gov/vdelivery/Datasets/Staged/Elevation/LPC/Projects).
